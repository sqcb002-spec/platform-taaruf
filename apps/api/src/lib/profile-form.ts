  ...
  },
  {
    ...
    fields: [
      ...
      { name: "timeline", label: "Kapan Anda siap menikah?", type: "select", options: ["Kurang dari 3 bulan", "3–6 bulan", "6–12 bulan", "Lebih dari 1 tahun"] },
      {
        ...
        label: "Bayangkan proses sudah serius dan calon mengharapkan kedekatan emosional serta kehidupan suami-istri yang wajar. Mana yang paling menggambarkan kesiapan Anda?",
        type: "select",
        options: [
          "Saya siap dan nyaman menjalani pernikahan dengan lawan jenis",
          "Saya siap, tetapi masih perlu belajar membangun kedekatan",
          "Ada keraguan atau pergumulan pribadi yang perlu saya selesaikan",
          "Saya ingin membahas kesiapan ini secara privat dengan mediator",
        ],
        sensitive: true,
      },
      {
        name: "personalHistoryDisclosure",
        label: "Adakah pengalaman kedekatan, pola ketertarikan, atau pergumulan pribadi—dulu maupun sekarang—yang mungkin memengaruhi komitmen tersebut?",
        type: "select",
        options: [
          "Tidak ada yang berdampak pada kesiapan saya",
          "Pernah ada, sudah selesai dan tidak berdampak saat ini",
          "Ada hal yang masih saya proses dan bersedia membahasnya secara privat",
          "Saya memilih menjelaskannya langsung kepada mediator",
        ],
        sensitive: true,
      },
      {
        name: "sexualIdentityDetail",
        label: "Hal yang perlu diketahui mediator",
        type: "textarea",
        placeholder: "Opsional. Sampaikan hanya hal yang diperlukan agar mediator dapat mendampingi Anda dengan tepat.",
        sensitive: true,
        required: false,
      },
      {
