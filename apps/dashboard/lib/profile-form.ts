...
export const profileFormSections: ProfileSectionDefinition[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "hajjUmrah", label: "Riwayat haji atau umrah", required: false },
      ...
      { name: "sunnahPrayer", label: "Tahajjud, witir, dan dhuha", type: "select", options: ["Rutin", "Sesekali", "Belum rutin"], required: false },
      { name: "fasting", label: "Puasa sunnah", type: "select", options: ["Rutin", "Sesekali", "Belum rutin"], required: false },
      {
        name: "charity",
        label: "Zakat, sedekah, wakaf, dan infak",
        type: "select",
        options: ["Rutin sesuai kemampuan", "Sesekali", "Belum rutin"],
        required: false,
      },
